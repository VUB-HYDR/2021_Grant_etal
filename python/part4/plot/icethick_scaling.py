...
# This script processes data for an icethickness scaling plot
...
def itscale_proc(inDIR,airDIR):
    ...
    models = ['clm45','albm','simstrat-uog','vic-lake','lake'] # temporarily removed "lake"
