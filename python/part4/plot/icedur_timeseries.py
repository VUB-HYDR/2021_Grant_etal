...
#This script loops through annual fieldmeans of each lake model's icedur data for
...
# processing function
def ii_proc(inDIR,flag_main_SI):
...
def ii_plot(datasets,outDIR,var,prod,flag_svplt,dpi):
    ...
    time_fut = np.arange(2006,2099,1)
    ...
    if flag_svplt == 0:
        ...
        f.savefig(outDIR+'/si_f25.png',bbox_inches='tight',dpi=dpi)