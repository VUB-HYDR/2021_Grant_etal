...
# -*- coding: utf-8 -*-
"""
Created on Wed May  8 17:09:39 2019
...
# This script processes data for a watertemp scaling plot
...
def reader(filename):
    ...
    da = da.where(da>275).interpolate_na(dim='time',method='linear')
    dims = list(da.dims)
    discard = []
    if 'lat' in dims:
        discard.append('lat')
...
def wtscale_proc(inDIR,airDIR):
    ...
    impact_yrs['rcp26_x2100'] = air_ensembles['rcp26'][0][428].values
    impact_yrs['rcp26_y2100'] = ensembles['rcp26'][0][428].values
    ...
    impact_yrs['rcp60_x2100'] = air_ensembles['rcp60'][0][428].values
    impact_yrs['rcp60_y2100'] = ensembles['rcp60'][0][428].values
    ...
    impact_yrs['rcp85_x2100'] = air_ensembles['rcp85'][0][428].values
    impact_yrs['rcp85_y2100'] = ensembles['rcp85'][0][428].values
    
    return air_ensembles,ensembles,impact_yrs,datasets
