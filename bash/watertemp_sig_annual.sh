...
# # Daily files to 1971-2000 to 2070-2099 annual water temperature signals
        ...
        then
                ...
                then scen="historical"
                        ...
                        for per in "${hist_periods[@]}"; do
                            ...
                            then
                                    cdo yearmean $inDIR/$model/$force/$scen_folder/${model_fname}_${force}_ewembi_${scen}_${opt}_${var}_global_${tstep}_${per}.nc4 $workDIR/step_a_$per.nc
                        ...
                        # historical seasons
                        cdo -L timmean -seldate,1971-01-01T00:00:00,2000-12-31T00:00:00 $workDIR/step_b.nc $workDIR/annual_dummy_${force}_step1.nc

                        rm $workDIR/step_b_*.nc
                ...
                then
                        ...
                        for rcp in "${rcps[@]}"; do
                            ...
                            for per in "${fut_periods[@]}"; do
                                ...
                                then
                                        cdo yearmean $inDIR/$model/$force/$scen_folder/${model_fname}_${force}_ewembi_${rcp}_${opt}_${var}_global_${tstep}_${per}.nc4 $workDIR/step_a_$per.nc
                            ...
                            # future seasons
                            cdo -L timmean -seldate,2070-01-01T00:00:00,2099-12-31T00:00:00 $workDIR/step_b.nc $workDIR/annual_dummy_${force}_${rcp}_step1.nc
                ...
                then scen="historical"
                     per="1861_2005"
                        ...
                        then
                                ...
                                cdo -L timmean -yearmonmean -seldate,1971-01-01T00:00:00,2000-12-31T00:00:00 $inDIR/$model/$force/$scen_folder/${model_fname}_${force}_ewembi_${scen}_${opt}_${var}_global_${tstep}_${per}.nc4 $workDIR/step_a.nc

                        fi

                        # historical seasons
                        lev_indexer $workDIR/step_a.nc $workDIR/annual_dummy_${force}_step1.nc

                        rm $workDIR/step_a.nc
                ...
                then per="2006_2099"
                    ...
                    for rcp in "${rcps[@]}"; do
                            ...
                            then
                                    ...
                                    cdo -L timmean -yearmonmean -seldate,2070-01-01T00:00:00,2099-12-31T00:00:00 $inDIR/$model/$force/$scen_folder/${model_fname}_${force}_ewembi_${rcp}_${opt}_${var}_global_${tstep}_${per}.nc4 $workDIR/step_a.nc

                            fi

                            # future seasons
                            lev_indexer $workDIR/step_a.nc $workDIR/annual_dummy_${force}_${rcp}_step1.nc
...
for rcp in "${rcps[@]}"; do
    ...
    for force in "${forcing[@]}"; do
        ...
        cdo sub $workDIR/annual_dummy_${force}_${rcp}_step1.nc $workDIR/annual_dummy_${force}_step1.nc $workDIR/annual_dummy_${force}_${rcp}_step2.nc

        # divide for scaled watertemp signal
        cdo divc,$scaler $workDIR/annual_dummy_${force}_${rcp}_step2.nc $workDIR/annual_dummy_${force}_${rcp}_step3.nc

        rm $workDIR/annual_dummy_${force}_${rcp}_step1.nc
...
echo $rcp
    ...
    cdo -O ensmean $workDIR/annual_dummy_*_${rcp}_step2.nc $workDIR/${model_fname}_${rcp}_${var}_annual_${prod}.nc

    ncwa -C -v lat,lon,$var -a time,levlak,lev $workDIR/${model_fname}_${rcp}_${var}_annual_${prod}.nc $outDIR/${model_fname}_${rcp}_${var}_annual_${prod}.nc

    # ensemble mean of scaled watertemp signals
    cdo -O ensmean $workDIR/annual_dummy_*_${rcp}_step3.nc $workDIR/${model_fname}_${rcp}_${var}_annual_scaled_${prod}.nc

    ncwa -C -v lat,lon,$var -a time,levlak,lev $workDIR/${model_fname}_${rcp}_${var}_annual_scaled_${prod}.nc $outDIR/${model_fname}_${rcp}_${var}_annual_scaled_${prod}.nc

    rm $workDIR/annual_dummy_*_${rcp}_step2.nc
    rm $workDIR/annual_dummy_*_${rcp}_step3.nc
